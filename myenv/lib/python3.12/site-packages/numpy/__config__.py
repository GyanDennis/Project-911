...
CONFIG = _cleanup(
    {
        ...
        "Build Dependencies": {
            "blas": {
                ...
                "openblas configuration": r"USE_64BITINT= NO_CBLAS= NO_LAPACK= NO_LAPACKE= DYNAMIC_ARCH=OFF DYNAMIC_OLDER=OFF NO_AFFINITY=1 USE_OPENMP= ARMV7 MAX_THREADS=0",
        ...
        "Python Information": {
            "path": r"/data/data/com.termux/files/home/Project-911/myenv/bin/python",
            "version": "3.12",
        },
        "SIMD Extensions": {
